...
-- (  
--	IDGROUP  integer  identity(1,1) constraint GROUPPK  primary key,
--	FACULTY   char(10) constraint  GROUPS_FACULTYFK foreign key         
--                                                         references FACULTY(FACULTY),
--     AUDITORIUM char(20) constraint  AUDITORIUMFK foreign key         
--                      references AUDITORIUM(AUDITORIUM),        
--     SUBJECT  char(10) constraint SUBJECTFK foreign key         
--                      references SUBJECT(SUBJECT), 
--     TEACHER  char(10) constraint TEACHER_NAMEFK foreign key         
--                      references TEACHER(TEACHER),
--	DAYWEEK char(2),
--	AUDITORIUM_TYPE     char(10) constraint  AUDITORIUM_AUDITORIUM_TYPEFK foreign key         
--                      references AUDITORIUM_TYPE(AUDITORIUM_TYPE)

--  )
--  insert into TIMETABLE (FACULTY, AUDITORIUM, SUBJECT, TEACHER, DAYWEEK,AUDITORIUM_TYPE)
--    values ('ИТ','206-1', 'СУБД', 'СМЛВ', 'пн', 'ЛК'), 
--                ('ИТ','206-1', 'БД', 'АКНВЧ', 'вт', 'ЛК-К'),
--                ('ИТ','301-1', 'СУБД', 'КЛСНВ', 'ср','ЛК-К'),
--                ('ИТ','301-1', 'ИНФ', 'БРКВЧ', 'чт', 'ЛБ-К'),
--                ('ИТ','206-1', 'ОАиП', 'ДТК', 'пт', 'ЛБ-СК'),
--                ('ИТ','206-1', 'БД', 'УРБ', 'сб', 'ЛБ-X'),
--                ('ИТ','206-1', 'МСОИ', 'БРКВЧ', 'вс', 'ЛБ-X'),
--                ('ИТ','236-1', 'ПИС', 'ДТК', 'вт', 'ЛБ-СК'),
--                ('ИТ','236-1', 'СУБД', 'УРБ', 'пн', 'ЛБ-X'),
--                ('ИТ','236-1', 'КГ', 'ГРН', 'ср', 'ЛК'),
--                ('ИТ','236-1', 'ДМ', 'ЖЛК', 'пн','ЛБ-X'),
--                ('ХТиТ','236-1', 'ИНФ', 'МРЗ', 'чт', 'ЛБ-К'),                                                
--                ('ХТиТ','236-1', 'МП', 'БРНВСК', 'пн', 'ЛБ-К'),
--                ('ХТиТ','236-1', 'ПЗ', 'НВРВ', 'пт', 'ЛБ-X'),
--                ('ХТиТ','236-1', 'ЛЭВМ', 'РВКЧ', 'чт', 'ЛБ-X'),
--                ('ТОВ','313-1', 'БД', 'ДМДК', 'ср', 'ЛК-К'),
--                ('ТОВ','313-1', 'ОХ', 'БРГ', 'пт', 'ЛБ-X'),
--                ('ТОВ','313-1', 'ПЗ', 'РЖК', 'пн', 'ЛК'),
--                ('ТОВ','313-1', 'ИНФ', 'ЗВГЦВ', 'сб','ЛБ-СК'),
--                ('ЛХФ','313-1', 'ОАиП', 'БЗБРДВ', 'вт', 'ЛБ-X'),    
--                ('ЛХФ','313-1', 'ЭТ', 'НСКВЦ', 'вс', 'ЛБ-К'),
--                ('ЛХФ','313-1', 'БД', 'СМЛВ', 'ср', 'ЛБ-СК'),
--                ('ЛХФ','324-1', 'ООП', 'АКНВЧ', 'вс', 'ЛК-К'),
--                ('ЛХФ','324-1', 'ВТЛ', 'КЛСНВ', 'вт', 'ЛБ-X'),  
--                ('ТТЛП','413-1', 'ИНФ', 'БРКВЧ', 'чт', 'ЛК'),
--                ('ТТЛП','413-1', 'ТОПИ', 'ДТК', 'пн', 'ЛБ-X'),
--                ('ТТЛП','413-1', 'ПСП', 'УРБ', 'ср', 'ЛК'),
--                ('ИЭФ','423-1', 'БЛЗиПсOO', 'ГРН', 'вс','ЛБ-К'), 
--                ('ИЭФ','423-1', 'ОАиП', 'ЖЛК', 'вс', 'ЛК-К'),     
--                ('ИЭФ','423-1', 'ТРИ', 'МРЗ', 'сб', 'ЛБ-СК'),
--                ('ИЭФ','408-2', 'ПСП', 'БРНВСК', 'пн', 'ЛБ-X'),
--                ('ИЭФ','408-2', 'ПЭХ', 'НВРВ', 'вт', 'ЛБ-X') 