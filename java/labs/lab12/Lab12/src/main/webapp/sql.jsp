...
<sql:setDataSource var = "snapshot" driver = "com.microsoft.sqlserver.jdbc.SQLServerDriver"
                   url = "jdbc:sqlserver://localhost:1433;database=Lab09;encrypt=true;trustServerCertificate=true;encrypt=false;IntegratedSecurity=false"
                   user = "SA"  password = "Nastya34lm"/>
